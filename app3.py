...
# 페이지 구성
st.set_page_config(page_title="그릭요거트 시맨틱 검색", layout="wide")
...
# 메인 UI
st.title("그릭요거트 블로그 시맨틱 검색")
st.write("Supabase 벡터 데이터베이스에 저장된 그릭요거트 관련 블로그 데이터를 시맨틱 검색합니다.")

# 검색 설정 UI
st.sidebar.title("검색 설정")

# 검색 입력
query = st.text_input("검색어 입력", value="그릭요거트", help="검색할 키워드나 문장을 입력하세요")
